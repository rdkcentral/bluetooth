...
#define BTRCORE_MAX_NUM_BT_DISCOVERED_DEVICES 128
...
typedef struct _stBTRCoreBTDevice { 
    ...
    unsigned int                  ui32VendorId;
    unsigned int                  ui32DevClassBtSpec;  
    unsigned int                  ui32ModaliasProductId;
    unsigned int                  ui32ModaliasVendorId;
    unsigned int                  ui32ModaliasDeviceId;
    unsigned short                ui16DevAppearanceBleSpec;
...
typedef struct _stBTRCoreScannedDevicesCount {
    int                     numberOfDevices;
    stBTRCoreBTDevice       devices[BTRCORE_MAX_NUM_BT_DISCOVERED_DEVICES];
...
enBTRCoreRet BTRCore_BatteryWriteOTAControl (tBTRCoreHandle hBTRCore,tBTRCoreDevId aBTRCoreDevId,const char* apBtUuid,int value);
enBTRCoreRet BTRCore_BatterySetLED (tBTRCoreHandle hBTRCore,tBTRCoreDevId aBTRCoreDevId,const char* apBtUuid);
enBTRCoreRet BTRCore_BatteryOTADataTransfer (tBTRCoreHandle hBTRCore,tBTRCoreDevId aBTRCoreDevId,const char* apBtUuid,char *FileName);
...
/**
 * @brief  This API returns the battery level of the specified device as a percentage.
 *
 * @param[in]  hBTRCore                Bluetooth core handle.
 * @param[in]  aBTRCoreDevId           Device Id of the remote device.
 * @param[in]  aenBTRCoreDevType       Type of bluetooth device HFP(Hands Free Profile) headset, audio source etc.
 * @param[out] pDeviceBatteryLevel     Stores the found battery level
 *
 * @return  Returns the status of the operation.
 * @retval  Returns enBTRCoreSuccess on success, appropriate error code otherwise.
 */
enBTRCoreRet BTRCore_GetDeviceBatteryLevel ( tBTRCoreHandle hBTRCore, tBTRCoreDevId aBTRCoreDevId, enBTRCoreDeviceType aenBTRCoreDevType, unsigned char * pDeviceBatteryLevel);
/**
 * @brief  This API returns current media info that includes the codec info, channel modes, subbands etc.
 *
 * @param[in]  hBTRCore                Bluetooth core handle.
 ...
 * @retval  Returns enBTRCoreSuccess on success, appropriate error code otherwise.
 */
enBTRCoreRet BTRCore_newBatteryLevelDevice (tBTRCoreHandle apsthBTRCore);
...
/**
 * @brief  This API is used to release advertisement registration
 *
 * @param[in]  hBTRCore                 Bluetooth core handle 
 *
 * @return  Returns the status of the operation.
 * @retval  Returns enBTRCoreSuccess on success, appropriate error code otherwise.
 */
enBTRCoreRet BTRCore_ReleaseAdvertisement(tBTRCoreHandle  hBTRCore);

/**
 * @brief  This API is used to set advertisement type & name
 *
 * @param[in]  hBTRCore                 Bluetooth core handle 
 * @param[in]  aAdvtType                Advertisement type
 * @param[in]  aAdvtBeaconName          Advertisement name
 *
 * @return  Returns the status of the operation.
 * @retval  Returns enBTRCoreSuccess on success, appropriate error code otherwise.
 */
enBTRCoreRet BTRCore_SetAdvertisementInfo(tBTRCoreHandle hBTRCore, char *aAdvtType, char *aAdvtBeaconName);
...
/**
 * @brief  This API is used to Remove Service Info value
 *
 * @param[in]  hBTRCore                 Bluetooth core handle
 * @param[in]  aUUID                    service with the UUID to be removed
 *
 * @return  Returns the status of the operation.
 * @retval  Returns enBTRCoreSuccess on success, appropriate error code otherwise.
 */
enBTRCoreRet BTRCore_RemoveServiceInfo(tBTRCoreHandle hBTRCore, char *aUUID);
