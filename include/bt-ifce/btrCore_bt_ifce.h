 ...
 * DBus/GDBus layer abstraction for BT functionality
 */
...
/**
 * @brief Bluetooth LE XBB 1 UUID
 */
#define BT_UUID_GATT_XBB_1      "00000a18-0000-1000-8000-00805f9b34fb"
...
/**
 * @brief  Bluetooth PS4 controller vendor ID
 */
#define BT_PS4_HID_VENDOR_ID           0x054c

/**
 * @brief  Bluetooth PS4 controller product ID 1
 */
#define BT_PS4_HID_PRODUCT_ID_1        0x05c4

/**
 * @brief  Bluetooth PS4 controller product ID 2
 */
...
#define BT_MAX_NOTIFY_CHAR_PATH     10
...
typedef struct _stBTMediaStatusUpdate {
    ...
    union {
      ...
      unsigned short            m_mediaTransportDelay;
...
/**
 * @brief This API Initializes the Bluetooth core and fetches DBus/GDBus connection and returns a handle to the instance.
 *
 * This handle will be used in all future communication with the Bluetooth core.
 *
 * @retval Returns NULL if DBus/GDBus connection establishment fails.
 */
void* BtrCore_BTInitGetConnection (void);

/**
 * @brief This API DeInitializes the Bluetooth core and releases the DBus/GDBus connection.
 *
 * This handle will be used in all future communication with the Bluetooth core.
 * This function will release the memory allocated toBT Adapters  & BT agent.
 *
 * @param[in]  apBtConn   The DBus/GDBus connection handle as returned by BtrCore_BTInitGetConnection. NULL is valid for this API.
 *
...
/**
 * @brief  using this API, DBus/GDBus object path is registered with bluetooth agent path and current adapter's path.
 *
 * @param[in]  apBtConn       The DBus/GDBus connection handle as returned by BtrCore_BTInitGetConnection.
...
/**
 * @brief  Using this API, DBus/GDBus object path is unregistered with bluetooth agent path and current adapter's path.
 *
 * @param[in]  apBtConn       The DBus/GDBus connection handle as returned by BtrCore_BTInitGetConnection.
 * @param[in]  apBtAdapter    The current bluetooth Adapter path.
 * @param[in]  apBtAgentPath  The bluetooth agent path.
...
/**
 * @brief  This API obtains adapter list from DBus/GDBus object path.
 *
 * @param[in]  apBtConn        The DBus/GDBus connection handle as returned by BtrCore_BTInitGetConnection.
...
/**
 * @brief  Using this API adapter path is fetched from DBus/GDBus object path.
 *
 * @param[in]  apBtConn         The DBus/GDBus connection handle as returned by BtrCore_BTInitGetConnection.
 ...
 * @param[out] apvVal            Property value which has to be fetched from DBus/GDBus iterator.
 *
 * @return Returns the status of the operation.
 * @retval Returns 0 on success, appropriate error code otherwise.
 */
 ...
 * @param[in] aenBtOpIfceType    Bluetooth interface type.
 * @param[in] aunBtOpIfceProp    Bluetooth interface property whose property value has to be fetched.
 * @param[in] apvVal             Property value which has to be set to DBus/GDBus iterator.
 *
 * @return Returns the status of the operation.
 * @retval Returns 0 on success, appropriate error code otherwise.
 */
 ...
 * @param[out] apcDataString    The actual string that is fetched from DBus/GDBus iterator which matches the provided UUID.
 *
 * @return Returns the status of the operation.
 * @retval Returns 0 on success, appropiate error code otherwise.
 */
...
int BtrCore_BTBatteryOTADataTransfer (void* apstBtIfceHdl,const char* apBtGattPath,const char *uuid,char *FileName);
int BtrCore_BTBatteryWriteOTAControl (void* apstBtIfceHdl,const char* apBtGattPath,const char *uuid,int value);
int BtrCore_BTBatterySetLED (void* apstBtIfceHdl,const char* apBtGattPath,const char* uuid);
...
/**
 * @brief  This API is used to get the battery level of a device.
 *
 * @param[in] apstBtIfceHdl            The DBus/GDBus interface struct.
 * @param[in] lpcBTRCoreBTDevicePath   The path to the remote device
 * @param[out] pDeviceBatteryLevel     Stores the returned battery level
 *
 * @return Returns the status of the operation.
 * @retval Returns 0 on success, -1 error code otherwise.
 */
int BtrCore_BTGetBatteryLevel ( void*   apstBtIfceHdl, const char*  lpcBTRCoreBTDevicePath, unsigned char * pDeviceBatteryLevel);
...
/**
 * @brief  This API is used to control the volume for audio out device.
 *
 * @param[in]  apBtConn             The Dbus connection handle as returned by BtrCore_BTInitGetConnection.
 *
 * @param[in]  apMediaControlPath   Media Control Path
 * @param[in]  aenBTMediaOper       Media operation that has to be performed.
 *
 * @return  Method invocation success (or) failure is returned.
 */
int   BtrCore_BTDevMediaControlVolume (void* apBtConn, const char* apmediaControlPath, enBTMediaControlCmd  aenBTMediaOper);
 ...
 *
 * @param[in]  apstBtIfceHdl           The DBus/GDBus connection handle as returned by BtrCore_BTInitGetConnection.
 * @param[in]  apBtAdapter             Bluetooth adapter
 * @param[in]  apstBtAdvInfo             Customized Adv Information
 *
 * @return Returns the status of the operation.
 * @retval Returns 0 on success, appropriate error code otherwise.
 */
int BtrCore_BTRegisterLeAdvertisement( void* apstBtIfceHdl, const char* apBtAdapter, stBTLeCustomAdv* apstBtAdvInfo);
 ...
 * @param[in]  apstBtIfceHdl           The DBus/GDBus connection handle as returned by BtrCore_BTInitGetConnection.
 * @param[in]  apBtAdapter             Bluetooth adapter
 * @param[in]  stBTLeGattInfo          Ble Gatt service information
 *
 * @return Returns the status of the operation.
 * @retval Returns 0 on success, appropriate error code otherwise.
 */
int BtrCore_BTRegisterLeGatt (void* apBtConn, const char* apBtAdapter, stBTLeGattInfo*);
 ...
 * @retval Returns 0 on success, appropriate error code otherwise.
 */
int BtrCore_BTReleaseAdvertisement (void* apBtConn, const char* apBtAdapter);
