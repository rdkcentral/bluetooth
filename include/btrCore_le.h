...
enBTRCoreRet BtrCore_LE_BatteryOTATransfer (tBTRCoreLeHdl hBTRCoreLe,tBTRCoreDevId atBTRCoreDevId,const char*  apcBtUuid,char *FileName);
enBTRCoreRet BtrCore_LE_BatterySetLED (tBTRCoreLeHdl hBTRCoreLe,tBTRCoreDevId atBTRCoreDevId,const char* apcBtUuid);
enBTRCoreRet BtrCore_LE_BatteryWriteOTAControl (tBTRCoreLeHdl hBTRCoreLe,tBTRCoreDevId atBTRCoreDevId,const char* apcBtUuid,int value);
...
/**
 * @brief  This API is used to store the advertisement type & name supported by device 
 *
 * @param[in]  hBTRCoreLe               Handle to bluetooth low energy device interface.
 ...
 * @retval  Returns enBTRCoreSuccess on success, appropiate error code otherwise.
 */
enBTRCoreRet BTRCore_LE_SetAdvertisementInfo(tBTRCoreLeHdl hBTRCoreLe, char* aAdvtType, char* aAdvtBeaconName);
 ...
 * @retval  Returns enBTRCoreSuccess on success, appropiate error code otherwise.
 */
enBTRCoreRet BTRCore_LE_ReleaseAdvertisement(tBTRCoreLeHdl hBTRCoreLe, void* apBtConn, const char* apBtAdapter);
...
/**
 * @brief  This API is used to remove service info for the advertisement
 *
 * @param[in]  hBTRCoreLe               Handle to bluetooth low energy device interface.
 * @param[in]  aUUID                    UUID of the service to remove
 * @param[out] aNumGattServices         Returns number of gatt services
 *
 * @return  Returns the pointer to the service overwritten by last service
 * @retval  Returns NULL on failure, appropiate address otherwise.
 */
int* BTRCore_LE_RemoveGattServiceInfo(tBTRCoreLeHdl hBTRCoreLe, const char* apBtAdapter, char* aUUID, int *aNumGattServices);
